...
import static com.helospark.financialdata.service.GrowthAnalyzer.isFcfProfitableEveryYearSince;
...
public class ProfitabilityCalculator {
    ...
    public static Optional<Integer> calculateNumberOfFcfProfitable(CompanyFinancials company, double offset) {
        for (int i = 30; i > 0; --i) {
            if (isFcfProfitableEveryYearSince(company.financials, offset + i, offset)) {
                return Optional.of(i);
            }
        }
        return Optional.of(0);
